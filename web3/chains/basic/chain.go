...
type Chain interface {
	...
	// SendRawTransaction Send the raw transaction on-chain
	// @return the hex hash string
	SendRawTransaction(signedTx string) (string, error)

	// SendSignedTransaction Send the signed transaction on-chain
	// @return the hex hash string
	SendSignedTransaction(signedTxn SignedTransaction) (*OptionalString, error)

	// FetchTransactionDetail Fetch transaction details through transaction hash
