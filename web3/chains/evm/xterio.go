...
func (h *XterioHandler) GasLimit() uint64 {
	return 21_0000
}
...
func (h *XterioHandler) NativeBalance(address common.Address) (*big.Int, error) {
	return h.Client().BalanceAt(context.Background(), address, nil)
}

// TokenBalance 获取代币余额
func (h *XterioHandler) TokenBalance(tokenAddress common.Address, ownerAddress common.Address) (*big.Int, error) {
...
func (h *XterioHandler) TokenDecimals(tokenAddress common.Address) (uint8, error) {
	opts := &bind.CallOpts{}
