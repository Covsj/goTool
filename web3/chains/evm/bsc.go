...
func (h *BscHandler) GasLimit() uint64 {
	return 21_0000
}
...
func (h *BscHandler) NativeBalance(address common.Address) (*big.Int, error) {
	return h.Client().BalanceAt(context.Background(), address, nil)
}

// TokenBalance 获取代币余额
func (h *BscHandler) TokenBalance(tokenAddress common.Address, ownerAddress common.Address) (*big.Int, error) {
...
func (h *BscHandler) TokenDecimals(tokenAddress common.Address) (uint8, error) {
	opts := &bind.CallOpts{}
