...
import (
	...
	"github.com/Covsj/goTool/web3/graphql"
...
func (t *Src20Token) Chain() basic.Chain {
	return t.chain
}

func (t *Src20Token) TokenInfo() (*basic.TokenInfo, error) {
...
func (t *Src20Token) BalanceOfAddress(address string) (*basic.Balance, error) {
...
func (t *Src20Token) BalanceOfAccount(account basic.Account) (*basic.Balance, error) {
	return t.BalanceOfAddress(account.Address())
}

func (t *Src20Token) BuildTransfer(sender, receiver, amount string) (txn basic.Transaction, err error) {
...
func (t *Src20Token) BuildTransferAll(sender, receiver string) (txn basic.Transaction, err error) {
