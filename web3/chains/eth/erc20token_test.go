...
func TestErc20Token_TokenInfo(t1 *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want:     &basic.TokenInfo{Name: "Tether USD", Symbol: "USDT", Decimal: 6},
		},
		{
			name:     "binance prod USDC",
			rpc:      rpcs.binanceProd.url,
			contract: rpcs.binanceProd.contracts.USDC,
			want:     &basic.TokenInfo{Name: "USD Coin", Symbol: "USDC", Decimal: 18},
		},
		{
			name:     "sherpax test BUSD",
			rpc:      rpcs.sherpaxTest.url,
			contract: rpcs.sherpaxTest.contracts.BUSD,
			want:     &basic.TokenInfo{Name: "Binance BUSD Token", Symbol: "BUSD", Decimal: 18},
		},
		{
			name:     "eth error rpc",
		...
		},
		{
			...
			want:     &basic.TokenInfo{Name: "Frax", Symbol: "FRAX", Decimal: 18},
		},
	}
