...
// 用户发红包 的操作
//
// Deprecated: use basic.NewRedPacketActionCreate
...
// 批量打开红包 的操作
//
// Deprecated: use basic.NewRedPacketActionOpen
...
// 结束红包领取 的操作
//
// Deprecated: use basic.NewRedPacketActionClose
...
func (rpa *RedPacketAction) EnsureApprovedTokens(account *Account, chain *Chain, spender string, coins int) (string, error) {
	...
	approveValue = basic.MaxBigInt(approveValue, amount)
...
// @param chain 要发红包的链
//
// Deprecated: use NewRedPacketContract() get basic.RedPacketContract, and SendTransaction(basic.Account, *basic.RedPacketAction)
...
// Deprecated: use basic.RedPacketDetail
type RedPacketDetail struct {
	*basic.TransactionDetail
...
// Deprecated: use basic.NewRedPacketDetail
func NewRedPacketDetail() *RedPacketDetail {
	return &RedPacketDetail{
		TransactionDetail: &basic.TransactionDetail{},
	}
}

// Deprecated: use basic.NewRedPacketDetailWithJsonString
