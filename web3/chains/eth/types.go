...
func NewTransactionNftTransfer(sender, receiver, gasPrice, gasLimit string, nft *basic.NFT) *Transaction {
...
func (t *Transaction) SignWithAccount(account basic.Account) (signedTx *basic.OptionalString, err error) {
	return nil, basic.ErrUnsupportedFunction
}

func (t *Transaction) SignedTransactionWithAccount(account basic.Account) (signedTx basic.SignedTransaction, err error) {
	return nil, basic.ErrUnsupportedFunction
}

func AsEthTransaction(txn basic.Transaction) *Transaction {
