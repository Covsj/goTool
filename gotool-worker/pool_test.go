...
func TestVIOLIN(t *testing.T) {
	...
	v := NewPoolWhitOption(WithMaxWorkers(2))
...
func TestMaxWorkers(t *testing.T) {
	...
	v := NewPoolWhitOption(WithMaxWorkers(0))
	v.Shutdown()
	if v.MaxWorkerNum() != 1 {
	...
	max := 13
	v = NewPoolWhitOption(WithMaxWorkers(max))
	defer v.Shutdown()
...
func TestSubmitWait(t *testing.T) {
	...
	v := NewPoolWhitOption(WithMaxWorkers(1))
	defer v.Shutdown()
...
func TestWorkerLeak(t *testing.T) {
	...
	v := NewPoolWhitOption(WithMaxWorkers(workerCount))
...
func benchmarkExecWorkers(n int, b *testing.B) {
	v := NewPoolWhitOption(WithMaxWorkers(n))
	defer v.Shutdown()
